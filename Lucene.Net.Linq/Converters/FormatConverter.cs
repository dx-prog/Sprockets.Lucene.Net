...
namespace Sprockets.Lucene.Net.Linq.Converters {
    internal class FormatConverter : TypeConverter {
        ...
        public FormatConverter(Type type, string format) {
            ...
            var dateTimeSpecificArguments = new[]
                {typeof(string), typeof(string), typeof(IFormatProvider), typeof(DateTimeStyles)};
            ...
            if (parseMethod == null)
                throw new ArgumentException("The type " + type +
                                            " does not declare a public static ParseExact(string, string, IFormatProvider) method.",
                    "type");
        }
