...
namespace Sprockets.Lucene.Net.Linq.Clauses.TreeVisitors {
    internal abstract class LuceneExpressionTreeVisitor : RelinqExpressionVisitor {
        ...
        protected virtual Expression VisitLuceneRangeQueryExpression(LuceneRangeQueryExpression expression) {
            ...
            return new LuceneRangeQueryExpression((LuceneQueryFieldExpression) field,
                (LuceneQueryPredicateExpression) lower,
                expression.LowerQueryType,
                (LuceneQueryPredicateExpression) upper,
