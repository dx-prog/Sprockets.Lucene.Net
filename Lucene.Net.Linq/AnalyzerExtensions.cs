...
namespace Sprockets.Lucene.Net.Linq {
    ...
    public static class AnalyzerExtensions {
        ...
        public static void AddAnalyzer<TDocument>(this PerFieldAnalyzerWrapper perFieldAnalyzerWrapper,
            Expression<Func<TDocument, object>> fieldName,
            Analyzer analyzer) {
            try {
                ...
                throw new ArgumentException(
                    "Field name must be specified as a lambda to a member property, ex. doc => doc.FirstName",
                    ex);
            }
        }
    }
