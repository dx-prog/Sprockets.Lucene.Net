...
namespace Lucene.Net.Linq.Tests.Mapping {
    ...
    public class ReflectionFieldMapperTests {
        ...
        public string ReadOnly => "You can't write to me";

        private ReflectionFieldMapper<ReflectionFieldMapperTests> CreateMapper(string propertyName,
            TypeConverter converter = null,
            Analyzer analyzer = null,
            QueryParser.Operator defaultParseOperaor = QueryParser.Operator.OR,
        ...
        public void AnalyzesQueryValue() {
            var mapper = CreateMapper("Text", analyzer: new StandardAnalyzer(Util.Version.LUCENE_30));
        ...
        public void CustomSort() {
            ...
            var sort = mapper.CreateSortField(false);
        ...
        public void NativeSortWithConverterSpecified() {
            var mapper = CreateMapper("Version",
                analyzer: new KeywordAnalyzer(),
        ...
        public void ParseMultipleTermsWithDefaultOperatorAnd() {
            var mapper = CreateMapper("Text",
                analyzer: new StandardAnalyzer(Util.Version.LUCENE_30),
                defaultParseOperaor: QueryParser.Operator.AND);
        ...
        public void SpecifyAnalyzer() {
            var mapper = CreateMapper("Text", analyzer: new PorterStemAnalyzer(Util.Version.LUCENE_30));
